...
<form method="post" class="mx-auto w-3/4 py-20 flex flex-col gap-8" use:enhance enctype="multipart/form-data">
	<div>
	...
	<div class="form-control">
		...
		<label class="label cursor-pointer justify-start gap-4">
			<input name="agree" value="ok" required type="checkbox" class="checkbox checkbox-primary" />
	...
	<div class="form-control gap-2">
		...
		<span class="p-10">
			...
			/>
			<span class="w-full flex justify-between text-xs px-2">
	...
	<div class="form-control">
		<input type="submit" class="btn btn-wide btn-outline btn-primary" value="送信">
	</div>
</form>